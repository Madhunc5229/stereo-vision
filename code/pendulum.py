...
def cameraPoseEst(essenMat):
    ...
    C1 = U[:,2]
    C2 = -U[:,2]
    print("Det of R1 and R2:",np.linalg.det(R1),np.linalg.det(R2))
...
#Select the best camera pose by checking Chirelity check
...
if __name__=='__main__':
    ...
    img1 = cv2.imread('../media/pendulum/im0.png')
    img2 = cv2.imread('../media/pendulum/im1.png')
    ...
    while True:
        try:
            fundMat , kp1, kp2 = bestFusingRansac(kp1,kp2)
